...
const DaySelectItem: FC<DaySelectItemProps> = (props) => {
    ...
    return (
        <div
            className={`${props.isSelected ? "bg-black shadow-md bg-opacity-80" : "bg-zinc-900 shadow-md"} md:mt-0 p-2 md:p-3 flex items-center gap-2 transition-all duration-150 bg-opacity-50 cursor-pointer rounded-xl`}
